	        ...
	        stage ('Deployments'){
	            parallel{
	                ...
	                stage ("Deploy to Production"){
	                    steps {
	                        sh "scp -p -r /var/lib/jenkins/workspace/maven_project_pipeline_as_code/target/vprofile-v1.war jenkins@${params.tomcat_UAT}:/usr/local/apache-tomcat-8.5.49/webapps"
	                    }
	                }
	            }
	        }
